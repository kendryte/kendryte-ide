...
Registry.as<IWorkbenchActionRegistry>(ActionExtensions.WorkbenchActions)
        .registerWorkbenchAction(new SyncActionDescriptor(MaixSerialUploadAction, MaixSerialUploadAction.ID, MaixSerialUploadAction.LABEL), 'Maix: Upload to chip', category);

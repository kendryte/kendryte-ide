import { garbageEvent, quoteMark } from 'vs/workbench/parts/maix/serialPort/upload/node/bufferConsts';
import { BaseTransformStream } from 'vs/workbench/parts/maix/serialPort/upload/node/baseTransform';

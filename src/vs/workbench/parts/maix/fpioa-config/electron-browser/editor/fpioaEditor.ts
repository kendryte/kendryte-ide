...
import { FpioaLeftPanel } from 'vs/workbench/parts/maix/fpioa-config/electron-browser/editor/leftPanel';
import { FpioaRightPanel } from 'vs/workbench/parts/maix/fpioa-config/electron-browser/editor/rightPanel';

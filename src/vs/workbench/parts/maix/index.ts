...
import 'vs/workbench/parts/maix/fpgio-config/electron-browser/fpgioContribution';
import 'vs/workbench/parts/maix/fpgio-config/common/packagings/maix1';
import 'vs/workbench/parts/maix/fpgio-config/common/packagings/testA';
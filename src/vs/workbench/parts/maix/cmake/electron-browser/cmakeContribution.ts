...
// CONFIGURE
Registry.as<IWorkbenchActionRegistry>(ActionExtensions.WorkbenchActions)
        .registerWorkbenchAction(new SyncActionDescriptor(MaixCMakeConfigureAction, MaixCMakeConfigureAction.ID, MaixCMakeDebugAction.LABEL), 'Maix: Configure', category);

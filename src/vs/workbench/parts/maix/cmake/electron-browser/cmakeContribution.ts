...
import { CMAKE_CHANNEL, ICMakeService, IMaixBuildSystemService } from 'vs/workbench/parts/maix/cmake/common/type';
import { MaixBuildSystemService } from 'vs/workbench/parts/maix/cmake/electron-browser/maixBuildSystemService';

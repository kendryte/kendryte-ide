...
import { IChipPackagingCalculated, IChipPackagingDefine, IPin, IPinRange } from 'vs/workbench/parts/maix/fpgio-config/common/packagingTypes';
import { normalizePin } from 'vs/workbench/parts/maix/fpgio-config/common/builder';

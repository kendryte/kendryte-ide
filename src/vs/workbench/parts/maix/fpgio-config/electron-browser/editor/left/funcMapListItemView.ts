...
import { selectValueCache } from 'vs/workbench/parts/maix/fpgio-config/electron-browser/lib/selectValueCache';
import { IOPinPlacement } from 'vs/workbench/parts/maix/fpgio-config/common/packagingTypes';

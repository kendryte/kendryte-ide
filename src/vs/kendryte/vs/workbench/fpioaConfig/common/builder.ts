import { ChipPackageType, IChipGeometry, IFuncDefinition, IFuncPinDefinition, IPin, IPin2DNumber } from 'vs/kendryte/vs/workbench/fpioaConfig/common/packagingTypes';

...
} from 'vs/kendryte/vs/workbench/serialPort/terminal/electron-browser/terminalActions';
import { Registry } from 'vs/platform/registry/common/platform';
import { SyncActionDescriptor } from 'vs/platform/actions/common/actions';
import { TerminalService } from 'vs/kendryte/vs/workbench/serialPort/terminal/electron-browser/terminalService';
...
import { TerminalPickerHandler } from 'vs/kendryte/vs/workbench/serialPort/terminal/browser/terminalQuickOpen';
import { SERIAL_MONITOR_COMMAND_ID, setupTerminalCommands } from 'vs/kendryte/vs/workbench/serialPort/terminal/common/terminalCommands';
import { setupTerminalMenu } from 'vs/kendryte/vs/workbench/serialPort/terminal/node/terminalMenu';

...
import { Direction, ISerialMonitorService, TERMINAL_PANEL_ID } from 'vs/kendryte/vs/workbench/serialPort/terminal/common/terminal';
...
import { TerminalEntry } from 'vs/kendryte/vs/workbench/serialPort/terminal/browser/terminalQuickOpen';

...
import { ITerminalChildProcess } from 'vs/kendryte/vs/workbench/serialPort/terminal/node/terminal';
import { Emitter, Event } from 'vs/base/common/event';
import { ISerialLaunchConfig, ISerialMonitorService, ITerminalProcessExtHostProxy } from 'vs/kendryte/vs/workbench/serialPort/terminal/common/terminal';
...
export class TerminalProcessExtHostProxy implements ITerminalChildProcess, ITerminalProcessExtHostProxy {
	...
	constructor(
		...
		cols: number,
		rows: number,
		@ISerialMonitorService private _terminalService: ISerialMonitorService,
	) {

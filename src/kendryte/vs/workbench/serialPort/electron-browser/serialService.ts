...
import { array_has_diff } from 'kendryte/vs/platform/common/utils';
import { RawContextKey } from 'vs/platform/contextkey/common/contextkey';
import { IQuickInputService, IQuickPickItem } from 'vs/platform/quickinput/common/quickInput';
import { ILogService } from 'vs/platform/log/common/log';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { MAIX_CONFIG_KEY_SERIAL_BAUDRATE } from 'kendryte/vs/platform/common/type';
import { ISerialPortService, SerialPortItem } from 'kendryte/vs/workbench/serialPort/node/serialPortService';

...
import { ACTION_ID_MAIX_SERIAL_UPLOAD, INodePathService } from 'kendryte/vs/platform/common/type';
import { ChipType, SerialLoader } from 'kendryte/vs/workbench/serialPort/upload/node/flasher';

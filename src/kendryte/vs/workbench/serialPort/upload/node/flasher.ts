...
import { QuotingBuffer, UnQuotedBuffer } from 'kendryte/vs/workbench/serialPort/upload/node/quotedBuffer';
import { EscapeBuffer, UnEscapeBuffer } from 'kendryte/vs/workbench/serialPort/upload/node/escapeBuffer';
import { ISPParseBuffer, ISPSerializeBuffer } from 'kendryte/vs/workbench/serialPort/upload/node/ispBuffer';
import { Disposable } from 'vs/base/common/lifecycle';
import { ISPError, ISPOperation, ISPRequest, ISPResponse } from 'kendryte/vs/workbench/serialPort/upload/node/bufferConsts';
import { createReadStream, ReadStream } from 'fs';
import { GarbageData, StreamChain } from 'kendryte/vs/workbench/serialPort/upload/node/streamChain';
import { CancellationToken, CancellationTokenSource } from 'vs/base/common/cancellation';
import { Event } from 'vs/base/common/event';
import { TPromise } from 'vs/base/common/winjs.base';
import { DeferredTPromise } from 'vs/base/test/common/utils';
import { ISPMemoryPacker } from 'kendryte/vs/workbench/serialPort/upload/node/ispMemoryPacker';
import { addDisposableEventEmitterListener } from 'kendryte/vs/platform/node/disposableEvents';
import { TimeoutBuffer } from 'kendryte/vs/workbench/serialPort/upload/node/timoutBuffer';
import { disposableStream } from 'kendryte/vs/platform/node/disposableStream';
import { SubProgress } from 'kendryte/vs/platform/common/progress';
import { lstat } from 'vs/base/node/pfs';
import { timeout } from 'vs/base/common/async';
import { ISPFlashPacker } from 'kendryte/vs/workbench/serialPort/upload/node/ispFlashPacker';
import { ChunkBuffer } from 'kendryte/vs/workbench/serialPort/upload/node/chunkBuffer';
import { createCipheriv, createHash } from 'crypto';
import { drainStream } from 'kendryte/vs/platform/common/drainStream';
import { IChannelLogger } from 'kendryte/vs/platform/node/channelLogService';

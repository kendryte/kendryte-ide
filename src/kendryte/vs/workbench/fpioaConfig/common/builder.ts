import { ChipPackageType, IChipGeometry, IFuncDefinition, IFuncPinDefinition, IPin, IPin2DNumber } from 'kendryte/vs/workbench/fpioaConfig/common/packagingTypes';

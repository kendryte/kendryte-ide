...
import { IPin2DNumber } from 'kendryte/vs/workbench/fpioaConfig/common/packagingTypes';
import { ColorMap, ContextMenuData, ID_NO_FUNCTION } from 'kendryte/vs/workbench/fpioaConfig/common/types';

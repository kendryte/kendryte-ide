...
import { AbstractTableRender, grid } from 'kendryte/vs/workbench/fpioaConfig/electron-browser/editor/right/abstract';
...
import { ColorMap } from 'kendryte/vs/workbench/fpioaConfig/common/types';

...
import { IFunc, IFuncPin } from 'kendryte/vs/workbench/fpioaConfig/common/packagingTypes';
...
import { ContextMenuData, ID_NO_FUNCTION, PinFuncSetEventEmitter } from 'kendryte/vs/workbench/fpioaConfig/common/types';
